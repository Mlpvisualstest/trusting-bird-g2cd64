...
const PORTFOLIO_IMAGES: PortfolioImage[] = [
  ...
  {
    id: 4,
    src: "https://images.unsplash.com/photo-1519741497673-10d95c10214a?auto=format&fit=crop&w=800&q=80",
    category: "Wedding",
  ...
  {
    id: 7,
    src: "https://images.unsplash.com/photo-1477959858617-67f8519776bf?auto=format&fit=crop&w=800&q=80",
    category: "Urban",
  ...
  {
    id: 10,
    src: "https://images.unsplash.com/photo-1426604966848-d56bc144cb85?auto=format&fit=crop&w=800&q=80",
    category: "Nature",
    title: "Forest Path",
  ...
  {
    id: 11,
    src: "https://images.unsplash.com/photo-1514565131-b847844be8b2?auto=format&fit=crop&w=800&q=80",
    category: "Urban",
    title: "Subway Symmetry",
    alt: "Subway station interior",
  },
  {
    id: 12,
    src: "https://images.unsplash.com/photo-1469334023215-813d9b071415?auto=format&fit=crop&w=800&q=80",
    category: "Nature",
    title: "Desert Dunes",
...
export default function App() {
  ...
  const [lightboxImage, setLightboxImage] = useState<PortfolioImage | null>(
    null
  );
  ...
  const enhanceVisionWithAI = async () => {
    ...
    const systemPrompt =
      "You are a creative director for Mlpvisuals photography. Enhance the client's rough idea into a beautiful, evocative 2-3 sentence photography mood board/concept. Focus on lighting, colors, and emotion. Return ONLY the enhanced description without any introductory text or quotes.";
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-fuchsia-500/30 selection:text-fuchsia-200 overflow-x-hidden">
      ...
      <nav
        className={`fixed w-full z-50 transition-all duration-500 ${
          scrolled
            ? "bg-zinc-950/70 backdrop-blur-xl py-4 border-b border-white/5"
            : "bg-transparent py-6"
        }`}
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          >
            ...
            <span className="text-2xl font-black tracking-tighter lowercase text-white group-hover:text-fuchsia-400 transition-colors">
              Mlpvisuals
            </span>
          </div>
          <div className="hidden md:flex gap-1 bg-white/5 px-2 py-1 rounded-full backdrop-blur-md border border-white/10">
            <button
              ...
              className="px-5 py-2 rounded-full text-sm font-semibold text-zinc-300 hover:text-white transition-all"
            >
              Work
            </button>
            <button
            ...
            <button
              ...
              className="px-5 py-2 rounded-full text-sm font-semibold bg-white text-black ml-2 hover:bg-zinc-200 transition-colors"
            >
              Book Now
            </button>
          </div>
          <button
            className="md:hidden w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-zinc-300"
        ...
        <div
          className={`md:hidden absolute top-0 left-0 w-full h-screen bg-zinc-950/95 backdrop-blur-2xl flex flex-col items-center justify-center gap-8 transition-all duration-500 ${
            isMobileMenuOpen
        ...
        >
          <button
            onClick={() => scrollToSection("portfolio")}
            className="text-4xl font-black hover:text-fuchsia-400 transition-colors"
          >
            Work.
          </button>
          <button
          ...
          <button
            onClick={() => scrollToSection("contact")}
            className="text-4xl font-black text-fuchsia-400"
          >
            Book Now
          </button>
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8">
            ...
            <span className="text-xs font-semibold uppercase text-zinc-300">
              Available for booking 2026
            </span>
          </div>
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter mb-6 leading-[0.9]">
            Modern <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 via-violet-400 to-blue-400 text-gradient">
              Storytelling.
            </span>
          </h1>
          <p className="text-lg md:text-2xl text-zinc-400 mb-10 max-w-2xl font-medium">
            Mlpvisuals brings your moments to life with vibrant, dynamic, and
            unapologetically bold photography.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={() => scrollToSection("portfolio")}
              className="group inline-flex items-center gap-2 bg-white text-black px-8 py-4 rounded-full font-bold hover:scale-105 transition-all shadow-xl shadow-white/5"
            >
              See the Work
            ...
            <button
              onClick={() => scrollToSection("contact")}
              className="px-8 py-4 rounded-full font-bold text-white bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors"
            >
              Book Now
            </button>
          </div>
      ...
      >
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div>
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4">
              Selected <span className="text-fuchsia-400">Works.</span>
            </h2>
            <p className="text-zinc-400 text-lg max-w-md">
              A curated collection of recent projects exploring light, color,
              and raw emotion.
            </p>
          </div>
              ...
              <button
                ...
                className={`px-5 py-2 rounded-2xl text-sm font-bold transition-all ${
                  activeCategory === category
                    ? "bg-gradient-to-r from-fuchsia-500 to-violet-500 text-white shadow-lg"
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
          {filteredImages.map((img) => (
            <div
              key={img.id}
              className="break-inside-avoid relative group overflow-hidden rounded-3xl cursor-pointer transform transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-fuchsia-500/10"
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/90 via-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-8">
                <span className="px-3 py-1 bg-white/10 backdrop-blur-md rounded-full text-xs font-bold text-fuchsia-300 w-fit mb-3">
                  {img.category}
                </span>
                <h3 className="text-2xl text-white font-black tracking-tight">
                  {img.title}
                </h3>
              </div>
            </div>
      ...
      <section id="about" className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-8 flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2 relative group">
            ...
            <img
              src="https://images.unsplash.com/photo-1554046920-90dcac824b20?auto=format&fit=crop&w=1000&q=80"
              className="relative w-full aspect-[4/5] object-cover rounded-3xl shadow-2xl"
              alt="Mlpvisuals Creator"
            />
          </div>
          <div className="w-full lg:w-1/2">
            ...
            <div className="space-y-6 text-zinc-300 text-lg md:text-xl font-medium leading-relaxed">
              <p>
                I'm a visual artist pushing the boundaries of modern
                photography. For me, an image isn't just a record of a
                moment—it's a canvas for color, energy, and storytelling.
              </p>
              <p>
                Ditching the overly-traditional, I specialize in creating
                vibrant, lively visuals that jump off the screen.
              </p>
            </div>
            <div className="mt-12 flex items-center gap-4 bg-white/5 border border-white/10 p-4 rounded-2xl w-fit backdrop-blur-sm">
              ...
              <div>
                <p className="font-bold text-white">Based in New York</p>
        ...
        <div className="bg-zinc-900 border border-white/5 rounded-[3rem] p-8 md:p-16 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 text-center mb-12">
            ...
            <p className="text-zinc-400 text-lg">
              Select your preferred service and timing below.
            </p>
          </div>
          <form
          ...
          >
            <div className="space-y-3">
              <label className="text-sm font-bold text-zinc-400 ml-2 uppercase tracking-widest">
                1. Choose Type of Service{" "}
                <span className="text-fuchsia-400">*</span>
              </label>
              <div className="flex flex-wrap gap-3">
                {["Portrait", "Wedding", "Urban/Editorial", "Commercial"].map(
                  (s) => (
                    <button
                      key={s}
                      type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <input
                type="text"
                placeholder="Name"
                className="w-full bg-zinc-950 border border-white/10 rounded-2xl px-6 py-4 text-white focus:border-fuchsia-500 outline-none transition-all"
                required
              />
              <input
                type="email"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <input
                type="date"
                className="w-full bg-zinc-950 border border-white/10 rounded-2xl px-6 py-4 text-white [color-scheme:dark] outline-none focus:border-fuchsia-500 transition-all"
                required
              />
              <input
                type="time"
                  ...
                  >
                    <Sparkles
                      className={`w-3.5 h-3.5 ${
                        isGeneratingVision ? "animate-spin" : ""
                      }`}
                    />
            ...
            <button
              type="submit"
              className={`w-full font-black text-lg py-5 rounded-2xl transition-all ${
                bookingService
                  ? "bg-gradient-to-r from-fuchsia-500 to-violet-600 text-white hover:shadow-xl hover:-translate-y-1"
      ...
      <footer className="py-12 text-center bg-zinc-950 border-t border-white/5">
        <div className="flex justify-center gap-6 mb-8">
          <a
            href="#"
            className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-zinc-400 hover:text-fuchsia-400 transition-all shadow-lg hover:shadow-fuchsia-500/20"
          >
            <InstagramIcon />
          </a>
          <a
        ...
        <p className="text-zinc-600 text-sm font-bold tracking-widest uppercase">
          &copy; {new Date().getFullYear()} Mlpvisuals. All rights reserved.
        </p>
      </footer>
